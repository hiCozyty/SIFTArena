...
function NativeSelectOption({
  ...
  return (
    <option
      ...
      className={cn("bg-card text-card-foreground checked:bg-primary checked:text-primary-foreground", className)}
      {...props}
    />
  )
}
