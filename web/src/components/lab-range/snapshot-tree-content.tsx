...
export function SnapshotTreeContent({ snapshotData, selectedIds, onSelectionChange }: { snapshotData: Record<string, SnapshotInfo>; selectedIds?: string[]; onSelectionChange?: (selectedIds: string[]) => void }) {
  ...
  return (
    <TreeProvider key={allIds.length} defaultExpandedIds={allIds} selectable={true} selectedIds={selectedIds} onSelectionChange={onSelectionChange} className="h-full" collapseDisabled noDeselect>
