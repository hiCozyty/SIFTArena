...
function AttackerConfigurationUi({
  ...
  const handleAddToScenario = useCallback(() => {
    ...
    setScenarioItems((prev) => [
      ...prev,
      { id: selected.type === "ability" ? selected.abilityId : "negative-control", abilityId: selected.type === "ability" ? selected.abilityId : "negative-control", name: selected.type === "ability" ? selected.name : "Negative Control", description: selected.type === "ability" ? (selected.description ?? "(no description)") : "An empty ability that does nothing.", command: selected.type === "ability" ? selected.command : "", winPrereq: selected.type === "ability" ? selected.winPrereq : "" },
    ])
