---
component_id: 5.11
component_name: Feature Integration Components
---
...
Higher-level workspace UIs that mount inside the shell — landing tabs with completion gating, attack configuration (technique tree + AI chat + ability tabs), lab range deployment (state, health, topology), knowledge graph, leaderboard, benchmark, SIFT agent, SNR, and settings page.

---

## Key References:

### /home/cozyty/Projects/shadowProtocol/web/src/components/app/landing-tabs.tsx (lines 119-142)
```
...
### /home/cozyty/Projects/shadowProtocol/web/src/components/lab-range/lab-range-content.tsx (lines 18-65)
```
...
### /home/cozyty/Projects/shadowProtocol/web/src/components/lab-range/use-lab-range-state.ts (lines 38-889)
```
...
### /home/cozyty/Projects/shadowProtocol/web/src/pages/settings.tsx (lines 10-48)
```
