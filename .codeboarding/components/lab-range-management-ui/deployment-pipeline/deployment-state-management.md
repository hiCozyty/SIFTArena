---
component_id: 7.8.1
component_name: Deployment State Management
---
...
The useDeploymentPipeline React hook — subscribes to real-time Ansible play recap data pushed from the WebSocket Gateway during active VM deployment, parses per-VM progress from Ansible output, and computes timeline items for the range visual UI.
