---
component_id: 1.6.2
component_name: Range Management Core
---

# Range Management Core

## Component Description

All server/range.js functions — VM lifecycle (deploy, delete, snapshot), range configuration, Ansible execution, and inventory management.
