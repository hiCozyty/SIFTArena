---
component_id: 5
component_name: Lab Range Dashboard
---
...
Frontend interface for monitoring lab environment status, visualizing VM topology graphs, tracking build progress via interactive timelines, editing range YAML configurations, and displaying agent file previews. Subscribes to backend WebSocket channels for real-time state updates.
...
### /home/cozyty/Projects/shadowProtocol/web/src/components/ui/file-preview.tsx (lines 10-26)
```
