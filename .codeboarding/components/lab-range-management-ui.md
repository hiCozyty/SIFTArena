---
component_id: 7
component_name: Lab Range Management UI
---

# Lab Range Management UI

## Component Description

Controls the range deployment lifecycle — YAML topology editor, interactive deployment timeline, VM topology visualization (powered by @xyflow/react), golden image management, and backend health gating that blocks operations when the server is unreachable.
