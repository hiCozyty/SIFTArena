---
component_id: 2
component_name: Range & Template Management
---

# Range & Template Management

## Component Description

Manages the full lifecycle of cyber range VMs — deploy, snapshot, restore, delete, and golden image preparation. Also handles YAML template building for range definitions. All operations pass through to the external Ludus HTTP API.
